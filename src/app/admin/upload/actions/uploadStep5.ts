...
export const uploadActionsStep5 = async (prevState: any, formData: FormData) => {
  ...
  if (treatment_options_parsed.length > 0) {
    ...
    if (treatmentError) {
      ...
      return {
        ...prevState,
        message: treatmentError.code || treatmentError.message,
        status: "error",
      };
    }
    ...
    if (hospitalTreatmentInserts.length > 0) {
      ...
      if (hospitalTreatmentError) {
        ...
        return {
          ...prevState,
          message: hospitalTreatmentError.code || hospitalTreatmentError.message,
          status: "error",
        };
    ...
    if (etc && etc.trim() !== "") {
      ...
      if (etcTreatmentError) {
        ...
        return {
          ...prevState,
          message: etcTreatmentError.code || etcTreatmentError.message,
          status: "error",
        };
      }
