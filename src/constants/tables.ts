...
// const TABLE_CONTACTS = "hospital_contacts";
...
// const TABLE_CONTACTS = "hospital_contacts_test";


const TABLE_HOSPITAL = "prepare_hospital";
const TABLE_DOCTOR = "prepare_doctor";
const TABLE_HOSPITAL_DETAIL = "prepare_hospital_details";
const TABLE_HOSPITAL_TREATMENT = "prepare_hospital_treatment";
const TABLE_HOSPITAL_BUSINESS_HOUR = "prepare_hospital_business_hour";
const TABLE_CONTACTS = "prepare_hospital_contacts";
